# concat.py  Combining numpy arrays into larger arrays
...
np.c_[x,y]        # columns (= horizontally)
np.r_[x,y]        # rows    (= vertically)

# as above, but specify the axis in an argument
np.concatenate((x,y), axis=0)  # combine along existing axis
